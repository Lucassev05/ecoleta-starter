...
function handleSelectedItem(event) {
  ...
  const alreadySelected = selectedItems.findIndex((item) => {
    const itemFound = item == itemId; //retorna true ou false, se false, ele roda no array selectedItems até true, se retornar true, o index do item é setado para alreadySelected
    return item == itemId;
  });

  // se ja estiver selecionado, tirar da array
